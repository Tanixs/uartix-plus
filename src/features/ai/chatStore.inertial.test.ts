...
vi.mock("../agent/agentRun", () => ({ occupiedSessionIds: () => new Set<string>() }));
vi.mock("../settings/settingsStore", () => ({
  getSnapshot: () => ({ aiBaseUrl: "https://example.invalid", aiApiKey: "test-key-not-real", aiModel: "test", aiCreativity: false }),
  subscribe: vi.fn(),
}));
