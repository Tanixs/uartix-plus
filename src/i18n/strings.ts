...
const zh: Dict = {
  ...
  "set.ai.grp.creative": "创造模式（AI 插件）",
  "set.ai.creative": "创造模式",
  "set.ai.creative.tip": "开启后 AI 可创造主题、小部件、面板等 UI 内容：统一经「Agent 任务」保存为插件并自动启用，在设置 → 插件管理里启停、配置、导入导出。",
  ...
  "set.ai.script.tip": "允许插件在小部件/面板沙箱里调用高权限动作（读数据快照、发送数据、控制软件）。受全局发送权限限制；插件违规会被自动隔离。",
  "set.ai.factory": "恢复出厂",
...
const en: Dict = {
  ...
  "set.ai.grp.creative": "Creative mode (AI plugins)",
  "set.ai.creative": "Creative mode",
  "set.ai.creative.tip": "When enabled, the AI can create themes, widgets, panels and other UI content: everything goes through Agent tasks, saved as plugins and auto-enabled. Manage them in Settings → Plugins.",
  ...
  "set.ai.script.tip": "Allow plugins to call high-privilege actions from widget/panel sandboxes (read snapshots, send data, control the app). Gated by the send permission; violating plugins are quarantined automatically.",
